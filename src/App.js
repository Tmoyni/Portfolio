    ...
    <div className="App">
      ...
      <header className="intro">
        ...
        <div className="intro__details">
          <div className="intro__about">Hello, I'm <span className="bld-color">Triona Moynihan</span> and I am a New York City based full-stack web developer and designer.</div>
